...
import net.moritz_htk.advanced_music_mod.datagen.provider.AMMItemTagsProvider;
...
public class AMMDataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new AMMItemTagsProvider(packOutput, lookupProvider, fileHelper));
    }
}