...
public class AMMAddItemModifier extends LootModifier {
    public static final Supplier<MapCodec<AMMAddItemModifier>> CODEC = Suppliers.memoize(() ->
            RecordCodecBuilder.mapCodec(inst ->
                    codecStart(inst)
                            ...
                            .apply(inst, AMMAddItemModifier::new)));

    private final Item item;
    private final List<Holder<LootItemFunction>> functions;
    private final BiFunction<ItemStack, LootContext, ItemStack> compositeFunction;

    public AMMAddItemModifier(LootItemCondition[] conditionsIn, Item item, final List<Holder<LootItemFunction>> functions) {
        super(conditionsIn);
        this.item = item;
